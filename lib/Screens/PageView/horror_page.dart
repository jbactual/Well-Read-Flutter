...
import 'package:well_read/Modal/horror_books.dart';

class HorrorPage extends StatefulWidget {
  const HorrorPage({ Key key }) : super(key: key);

  @override
  HorrorPageState createState() => new HorrorPageState();

}

class HorrorPageState extends State<HorrorPage>{
    ...
    return new Scaffold(
        ...
        bottomNavigationBar: new PreferredSize(
          ...
          child: new Container(
            ...
            child: new Text("Horror Books", textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16.0),),
          ),
        ),
    );
  }
