...
import 'package:well_read/Modal/action_books.dart';
    ...
    return new Scaffold(
      ...
      bottomNavigationBar: new PreferredSize(
        ...
        child: new Container(
          ...
          child:
          new Text("Action Books", textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16.0),),
        ),
      ),
    );
  }
