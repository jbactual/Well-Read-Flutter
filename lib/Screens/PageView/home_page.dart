...
class HomePageState extends State<HomePage>{
  ...
  Widget build(BuildContext context) {
    ///create book tile hero that are placed in the
    /// custom scroll view
    ...
    return new Scaffold(
        ...
        bottomNavigationBar: new PreferredSize(
          ...
          child: new Container(
            ...
            child: new Text("All Books", textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16.0),),
          ),
        ),
    );
  }
